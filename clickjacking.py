...
def sniff_icmp_response():
    ...
    if packets:
        ...
        print("Clickjacking - ICMP Type:", icmp_type)

        if icmp_type == 3:
            #stop_execution = True  # Set the flag to stop execution
            success = False
            print("Stopping clickjacking execution due to Type 3 ICMP response.")
            return success

    else:
        print("Clickjacking - No ICMP response captured.")
...
def main():
    ...
    try:
        ...
        print("Clickjacking request successful. Response code:", response_code)
        success = True
    except requests.exceptions.RequestException as e:
        print("Clickjacking request failed. Exception:", e)
        success = False
    finally: 
        ...
        print("Clickjacking execution completed.")
        return success
